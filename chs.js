...
var cnItems = {
    ...
    "Total Alien Eggs Earned": "获得的虫巢总数",
    ...
    "Wipe Local Data": "擦除本地存档数据",
    "Automate and double production": "自动化和双倍生产",
    ...
    "Items": "物品",
    "Ammunition": "弹药",
    "Automate and increase production": "自动化和提高产量",
    "Available Researches": "可用研究",
    "Drill": "钻头",
    "Researched Techs": "研究技术",
    "Rocketry 1": "火箭 1",
    "Science Pack": "科学包",
    "Show start/stop shortcut": "显示开始/停止快捷方式",
    "Show upgrade storage shortcut": "显示升级存储快捷方式",
    "Speed Production": "加速生产",
    "Unlocks Concrete Tech research": "解锁混凝土技术研究",
    "Piercing Shell": "穿甲弹壳",
    "Offline Gains": "离线收益",
    "Offline gains are limited to 24 hours": "离线收益上限为24小时",
    "You were away": "你离开了",
    "Alien Eggs": "虫巢",
    "and to escape from this hostile planet: produce packs, perform researches, unlock new productions, use": "并逃离这个充满敌意的星球：生产包装、进行研究、解锁新产品、使用",
    "are mandatory to produce some items and are used to speed up machine production.": "是生产某些物品的强制要求，用于加快机器生产。",
    "Build a": "建造一个",
    "Bullets": "子弹",
    "by killing aliens": "通过杀死虫子",
    "by killing them with weapons and ammunitions.": "用武器和弹药杀死他们。",
    "Collect 1": "收集 1",
    "Congratulations for your first": "恭喜你第一次",
    "Now you are able to build weapons and produce ammunitions. Moreover you could generate aliens to collect": "现在你可以制造武器和生产弹药了。 此外，您可以生成外星人来收集",
    "Produce": "生产",
    "So now, you know what to do to build": "所以现在，你知道如何构建",
    "to improve machines and finally produce more items!": "改进机器并最终生产出更多产品！",
    "Rocketry 2": "火箭 2",
    "Unlocks Explosive Rocket ammunition": "解锁爆炸火箭弹药",
    "Escape the planet": "逃离这个星球",
    "Fastest Win Time": "最快获胜时间",
    "Hardcore Mode": "硬核模式",
    "No more research available - check the \"Tutorial\"": "没有更多可用的研究 - 检查“教程”",
    "Total Alien Nest Killed": "外星巢穴被杀总数",
    "Unlocks Submachine Gun weapon": "解锁冲锋枪武器",
    "Will be implemented soon": "即将推出",
    "": "",
    "": "",
    "": "",
    "": "",
